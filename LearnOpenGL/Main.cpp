...
int main()
{
	...
	unsigned int triangle1_indices[] = {
		0, 1, 3, // first triangle
	};
	unsigned int triangle2_indices[] = {
	...
	glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(triangle1_indices), triangle1_indices, GL_STATIC_DRAW);
	...
	glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(triangle2_indices), triangle2_indices, GL_STATIC_DRAW);
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)0);
	glEnableVertexAttribArray(0);
